...
public class Utils {
    ...
    public static void waitWithoutInterrupt(Object object) {
        try {
            ...
            MLog.w(TAG, "unexpected interrupt: " + object);
        }
    }
    ...
    public static void debug(String message, Object... args) {
        MLog.v(DEBUG_TAG, String.format(message, args));
    }
     ...
     *
     * @param
     * @return boolean true 不支持 false 支持
     * @author Penn
     */
    public static boolean isNotSupportedPhoto(String path) {
        ...
        Log.i("Penn", "W:" + w + " H:" + h + "w / h  = 2 " + i + "   >2?" + (i > 2));
